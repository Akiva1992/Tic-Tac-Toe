...
const gameBoard = (()=>{
  ...
  const getCurrentBoard = ()=>{return board};
...
const pageManager = (()=>{
  ...
  const bindEventListeners = ()=>{
    document.querySelector(".p-vs-ai-header").addEventListener("click", showSinglePlayerForm);
    document.querySelector(".p-vs-p-header").addEventListener("click", showMultiplePlayerForm);
